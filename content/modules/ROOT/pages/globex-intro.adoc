...
Click to navigate to https://streams-console-globex-mw-{user_name}.{openshift_subdomain}[AMQ streams console]. This redirects you to the AMQ streams console login page. For the purpose of this workshop, choose *Sign in with Anonymous Session* to access the console
+
