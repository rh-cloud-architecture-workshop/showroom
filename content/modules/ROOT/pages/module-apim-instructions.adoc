...
++++
<img src="https://cdn.make.cm/make/s/rhqrpng?&data[rounded]=false&data[value]=https://globex-mobile-globex-apim-{user_name}.{openshift_subdomain}" style="width:90%;border-style: none;">
++++
