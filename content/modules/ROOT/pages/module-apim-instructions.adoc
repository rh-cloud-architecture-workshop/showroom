...
image::https://api.qrserver.com/v1/create-qr-code/?data=https%3A%2F%2Fglobex-mobile-globex-apim-user3.apps.cluster-5wrmt.5wrmt.sandbox5.opentlc.com[200,300]
...
----
* You can view the newly created OpenAPI specification {service_registry_ui_url}/ui/artifacts/globex/partnerapi/versions/latest[here^, window="serviceregistry"]
