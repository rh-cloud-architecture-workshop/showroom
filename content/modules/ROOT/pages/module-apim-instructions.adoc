...
++++
<img src="https://cdn.make.cm/make/s/rhqrpng%3Fdata%5Bvalue%5D%3Dhttps%3A%2F%2Fglobex-mobile-globex-apim-{user_name}.{openshift_subdomain}" style="width:90%;border-style: none;">
++++
