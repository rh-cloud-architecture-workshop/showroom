...
.QR Code
[source,bash,role=execute, subs="attributes"]
[#mobile-app,link=https://cdn.make.cm/make/s/rhqrpng?data[value]=https://globex-mobile-globex-apim-{user_name}.{openshift_subdomain}] 
image::mobile.jpg[Mobile,200,100]  


image::https://cdn.make.cm/make/s/rhqrpng%3Fdata%5Bvalue%5D%3Dhttps%3A%2F%2Fglobex-mobile-globex-apim-{user_name}.{openshift_subdomain} [Globex Mobile,200,300]
