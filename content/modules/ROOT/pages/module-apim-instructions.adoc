...
image::https://cdn.make.cm/make/s/rhqrpng?%26data%5Brounded%5D%3Dfalse%26data%5Bvalue%5D%3Dhttps%3A%2F%2Fglobex-mobile-globex-apim-{user_name}.{openshift_subdomain}[Globex Mobile,200,300]
