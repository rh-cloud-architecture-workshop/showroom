...
.API Module on Workshop Deplpoyer
image::apim/apim-workshop-deployer.png[width=70%]
...
image::https://cdn.make.cm/make/s/rhqrpng?&data[rounded]=false&data[value]=https://globex-mobile-globex-apim-{user_name}.{openshift_subdomain}[Globex Mobile,200,300]
