...
The Partner app developers will also need access to the Developer Portal to signup for the APIs exposed to them. For the purpose of this workshop let us use the inbuilt developer user `John`.
...
[NOTE] If the page doesn't load immediately, it could be that the Gateway isn't ready yet. Refresh after a short period of time.
