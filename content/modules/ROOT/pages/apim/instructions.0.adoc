...
image::apim/service-registry-home.png[]

. Click on the *Create group* button as shown in the screenshot. 
+
.Service Registry: Landing Page
image::apim/service-registry-create-grp.png[]

. Enter the `globex` as the Group ID in  the *Create Group* wizard, and click on the *Create* button.
+
.Service Registry: Landing Page
image::apim/service-registry-create-grp-wizard.png[]
+
*Group Id*
+
[source,bash,role=execute,subs="attributes"]
...
. Navigate to the `globex` group, and click on the *Create artifact* button as shown in the screenshot. 
+
.Service Registry: Landing Page
...
*Type*: 
+
Choose the types as *OpenAPI* from the dropdown.
