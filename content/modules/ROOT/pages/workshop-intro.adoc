...
+
image::intro/kafdrop-expand-message.png[]
+
image::intro/kafdrop-globex-tracking-message.png[]

* If you go back to the list of topics in the Kafdrop UI (using the browser back button or clicking on the Kafdrop header) image:intro/kafdrop-header-back.png[] , you will notice a number of topics starting with *globex.recommendation*. Those are the topics created by the _recommendation engine_ application, which calculates a list of the most popular products based on the user activity stream. +
...
+
image::intro/kafdrop-globex-tracking-recommendation.png[]
