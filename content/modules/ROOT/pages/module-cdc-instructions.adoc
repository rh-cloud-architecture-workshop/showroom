...
* On the top menu of the console, click on the image:cdc/openshift-application-menu.png[] icon, and in the drop-down box, select *Red Hat OpenShift Dev Spaces*.
+
image::cdc/openshift-application-menu-2.png[]
...
+
image::cdc/devspaces-workspace-starting.png[]

* Click on the *Open* link of the workspace.
+
image::cdc/devspaces-workspace-started-1.png[]
...
+
image::cdc/devspaces-trust-contents.png[]
...
* You can deploy the connector to the OpenShift cluster directly from Dev Spaces. To do so, click on the image:cdc/devspaces-menu.png[] icon on the top of the left menu, and select *Terminal/New Terminal* from the drop-down menu.
+
...
** Go into the terminal of the Dev Spaces workspace. If you don't have an open terminal, you can open a new one by selecting the image:cdc/devspaces-menu.png[] icon on the top of the left menu, and selecting *Terminal/New Terminal* from the drop-down menu.
