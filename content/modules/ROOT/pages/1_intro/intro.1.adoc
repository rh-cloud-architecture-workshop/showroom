...
<nav class="pagination" style="display: flex !important;">
  ...
  <span class="next"><a href="https://workshop-deployer.{openshift_subdomain}" target="workshopdeployer" class="query-params-link">Walkthrough of the Globex web application</a></span>
</nav>
++++
